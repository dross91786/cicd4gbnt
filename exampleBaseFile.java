...
public class TestBase  {
    ...
    /**
     * ThreadLocal variable which contains the Job Id.
     */
    ...
    public static Object[][] bsBrowserDataProvider(Method testMethod) {
        return new Object[][]{
     ...
     * version and os parameters, and which is configured to run against hub.browserstack.com, using
     * the username and access key populated by the {@link #authentication} instance.
     *
     * @param browser Represents the browser to be used as part of the test run.
     * @param version Represents the version of the browser to be used as part of the test run.
     * @param os Represents the operating system to be used as part of the test run.
     * @param methodName Represents the name of the test case that will be used to identify the test on Browserstack.
     * @return
    ...
    protected void createDriver(String browser, String version, String os, String methodName)
        ...
        // set desired capabilities to launch appropriate browser on Browserstack
